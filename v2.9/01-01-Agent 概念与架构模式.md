...
> 
> **来源**: 基于经典AI Agent理论（Russell & Norvig, 1995的感知-行动循环）+ LLM Agent架构实践（记忆层为LLM时代新增组件）
>
> **注**: 四层架构是对经典三层架构（感知-决策-执行）的扩展，记忆层是LLM Agent特有的组件，用于解决LLM无状态问题。
...
2. **Reflexion 论文**: Reflexion: Language Agents with Verbal Reinforcement Learning (2023 Q2, NeurIPS 2023, arXiv:2303.11366)
   - 链接：https://arxiv.org/abs/2303.11366
   - NeurIPS 2023: https://proceedings.neurips.cc/paper_files/paper/2023/hash/1b44b878bb782e6954cd888628510e90-Abstract-Conference.html
   - 参考内容：Reflexion 模式原理、反思机制设计
   - arXiv 提交时间：2023 年 3 月 21 日

3. **Plan-and-Execute 架构**: LangChain Planning Agents Blog (2024 Q1)
   - 链接：https://blog.langchain.com/planning-agents/
   - 参考内容：Plan-and-Execute架构实现、与ReAct对比、三种变体（Plan-and-Execute/ReWOO/LLMCompiler）
   - 说明：基于Plan-and-Solve论文（Wang et al., ACL 2023）和BabyAGI项目

4. **Plan-and-Solve 论文**: Plan-and-Solve Prompting (2023 Q2, ACL 2023, arXiv:2305.04091)
   - 链接：https://arxiv.org/abs/2305.04091
   - 参考内容：规划与求解两阶段Prompting方法，解决Zero-shot-CoT的缺失步骤错误
   - 注意：该论文提出的是Prompting方法，非完整Agent架构
